...
public class StudyModeService extends Service {
    ...
    public void initWindow()
    {
        ...
        rootLayout = (RelativeLayout) LayoutInflater.from(this).inflate(R.layout.layout_float,null);
        backLayout = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.layout_float_back,null);
    }
                ...
                switch (event.getAction())
                {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (System.currentTimeMillis() - downTime < 500 && (Math.abs(event.getRawX()) - Math.abs(rx) < 10 && Math.abs(event.getRawY()) - Math.abs(ry) < 10))
                        {
                            ...
                            createWindow();
                            Intent mActivity = new Intent(StudyModeService.this,MainActivity.class);
